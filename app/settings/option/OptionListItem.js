...
const SecondaryActionButton = ({ tooltip, enabled, onClick, icon }: SecondaryActionButtonProps) => (
...
const OptionListItem = ({
  theme, subtitle, changed, resettable, onUndoButton, onResetButton, children
}: OptionListItemProps) => (
  <ListItem>
    <ListItemIcon>
      <Icon>
