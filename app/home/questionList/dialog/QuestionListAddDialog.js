...
type Props = {
  ...
  onQuestionChange: (SyntheticInputEvent<>) => ?mixed,
  onAnswerChange: (SyntheticInputEvent<>) => ?mixed,
  onIncorrectAnswerDelete: number => ?mixed,
  onIncorrectAnswerAdd: () => ?mixed,
  onTempIncorrectAnswerChange: (SyntheticInputEvent<>) => ?mixed,
  handleClose: () => ?mixed
};
...
const QuestionListAddDialog = ({
  ...
  onQuestionChange,
  onAnswerChange,
  onIncorrectAnswerDelete,
  onIncorrectAnswerAdd,
  onTempIncorrectAnswerChange,
  handleClose
}: Props) => {
  const confirmEnabled =
    incorrectAnswers.length > 0 && question !== '' && answer !== '';
