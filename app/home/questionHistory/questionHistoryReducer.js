...
import {
  CHANGE_SORT_BY,
  CHANGE_SORT_ORDER,
  CHANGE_INCLUDE_CANCELLED,
  CHANGE_QUESTION_SEARCH,
  LOAD_HISTORY,
  HISTORY_LOADED
...
const questionHistory = (
  state: QuestionHistoryState = defaultState,
  action: ActionType
) => {
  switch (action.type) {
    case CHANGE_SORT_BY:
    ...
    case CHANGE_INCLUDE_CANCELLED:
      if (
        ...
        action.payload !== null &&
        typeof action.payload === 'object' &&
        action.payload.includeCancelled !== undefined &&
        action.payload.includeCancelled !== null &&
    ...
    case CHANGE_QUESTION_SEARCH:
      if (
        ...
        action.payload !== null &&
        typeof action.payload === 'object' &&
        action.payload.questionSearch !== undefined &&
        action.payload.questionSearch !== null &&
    ...
    case HISTORY_LOADED:
      if (
        ...
        action.payload !== null &&
        typeof action.payload === 'object' &&
        action.payload.loadedHistory !== undefined &&
        action.payload.loadedHistory !== null &&
        action.payload.loadedHistory.constructor === Array &&
        action.payload.recordCount !== undefined &&
        action.payload.recordCount !== null &&
